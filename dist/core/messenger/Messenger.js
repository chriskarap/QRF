System.register(['../transport/LocalTransport', '../utils/string'], function (_export, _context) {
    "use strict";

    var localTransport, UID;
    return {
        setters: [function (_transportLocalTransport) {
            localTransport = _transportLocalTransport.localTransport;
        }, function (_utilsString) {
