System.register(['./Particle', '../sculpt', '../time', '../utils', '../error', '../constants', '../loader', '../math'], function (_export, _context) {
    "use strict";

    var Particle, Sculpt, Time, number, vector3, object, ErrorProtectedMethodCall, CONST, Loader, Vector3;
    return {
        setters: [function (_Particle) {
        ...
        execute: function () {
            ...
            class ParticleSystem extends Sculpt {
                constructor(params) {
                ...
                update(e) {
                    ...
                    let addNewCount = Math.min(number.addNoise(this.params.numberPerSecond.value, this.params.numberPerSecond.randomness) / 1000 * Time.delta, number.addNoise(this.params.maxParticles.value, this.params.maxParticles.randomness) - this.particles.length) + this._halfParticles;
                ...
                createParticle() {
                    let particle = new Particle(this.params.particlesMaterial, this.params.lifetime, this.params.particleSize, this.params.startPosition);
