System.register(['../eventEmitter', '../messenger', '../constants', '../sculpt', '../rodinEvent', '../raycaster', '../scene', '../avatar'], function (_export, _context) {
    "use strict";

    var EventEmitter, messenger, CONST, Sculpt, RodinEvent, Raycaster, Scene, Avatar;
    return {
            ...
            class GamePad extends EventEmitter {
                ...
                static getControllerFromNavigator(id, hand = null) {
                    ...
                    for (let i = 0; i < navigatorGamepads.length; i++) {
                        if (navigatorGamepads[i] === null) continue;
                ...
                emitIntersected(e, eventName, DOMEvent, button) {
                    if (this.currentIntersections !== null) this.emitAll(e, this.intersected, eventName, DOMEvent, button);
                }
