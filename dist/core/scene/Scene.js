System.register(['../eventEmitter', '../messenger', '../error', '../utils', '../constants', '../rodinEvent', '../sculpt', '../avatar', '../device'], function (_export, _context) {
    "use strict";

    var EventEmitter, messenger, ErrorProtectedMethodCall, ErrorBadValueParameter, utils, CONST, RodinEvent, Sculpt, Avatar, device;
    return {
        ...
        execute: function () {
            ...
            class Scene extends EventEmitter {
                ...
                static getByName(name) {
                    ...
                    if (filteredScene && filteredScene[0]) return filteredScene[0];
            ...
            if (device.isIframe && device.isIOS) {
                ...
                if (Scene.active) Scene.onResize();
            }
