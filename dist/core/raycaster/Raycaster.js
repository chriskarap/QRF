System.register(['../scene', '../sculpt', '../sculpt/Box', '../sculpt/Sphere', '../math/Vector3', '../utils', '../math'], function (_export, _context) {
    "use strict";

    var Scene, Sculpt, Box, Sphere, Vector3, utils, RodinMath;
    return {
        setters: [function (_scene) {
            ...
            Box = _sculptBox.Box;
        }, function (_sculptSphere) {
            Sphere = _sculptSphere.Sphere;
