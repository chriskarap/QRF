                ...
                constructor({
                    ...
                    const draw = () => {
                        ...
                        if (this.background.image) {
                            ...
                            ctx.fillStyle = "rgba(" + rgb.r + ", " + rgb.g + ", " + rgb.b + ", " + this.background.opacity + ")";
                        ...
                        if (this.label) {
                            let x = 50;
                            let y = 50;
                            let textSize = utils3D.measureTextOnCanvas(this.label.text, this.label.fontFamily, this.label.fontStyle, this.label.fontSize * this.ppm, this.canvas);
                            ...
                            if (textSize.x > this.ppm * this.width) {
                                ...
                                textSize = utils3D.measureTextOnCanvas(this.label.text, this.label.fontFamily, this.label.fontStyle, this.label.fontSize * this.ppm, this.canvas);
                            }
                        ...
                        if (this.border && this.border.width) {
                            ...
                            ctx.strokeStyle = "rgba(" + rgb.r + ", " + rgb.g + ", " + rgb.b + ", " + (this.border.opacity ? this.border.opacity : 1) + ")";
                            ctx.stroke();
                            /*                          document.body.appendChild(canvas);
                             canvas.style.zIndex = 9999999999;
                             canvas.style.position = "absolute";
