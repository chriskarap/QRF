System.register(['../Sculpt', '../../utils', '../../math'], function (_export, _context) {
    "use strict";

    var Sculpt, utils3D, Vector3;
    return {
        ...
        execute: function () {
            ...
            class Text extends Sculpt {
                ...
                draw() {
                    ...
                    let textSize = utils3D.measureTextOnCanvas(this.text, this.fontFamily, this.fontStyle, this.fontSize * this.ppm, this.canvas);
