System.register(['./Sculpt', '../utils', '../loader'], function (_export, _context) {
    "use strict";

    var Sculpt, AScheme, Loader;
    return {
                ...
                static loadFont(font, reverse = false) {
                    ...
                    if (!font.substring(font.lastIndexOf('.') + 1).startsWith("json")) {
                        Loader.loadFont(font, rawFont => {
                            Text3D.fonts[font] = threeFontLoader.parse(JSON.parse(convert(rawFont, reverse)));
