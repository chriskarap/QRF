System.register(['./Sculpt'], function (_export, _context) {
    "use strict";
            ...
            class GazePoint {
                constructor(sculpt = null) {
                    ...
                    this.Sculpt.on('update', evt => {
                        ...
                        if (this.controller.intersected.length === 0 || this.controller.intersected.length === 1 && this.controller.intersected[0].distance === Infinity) {
