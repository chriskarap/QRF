System.register(['./tween', '../rodinEvent', '../constants', '../error', '../sculpt/Sculpt', '../eventEmitter', '../messenger', '../utils'], function (_export, _context) {
    "use strict";

    var TWEEN, RodinEvent, CONST, ErrorProtectedMethodCall, Sculpt, EventEmitter, messenger, object;
    ...
    return {
        ...
        execute: function () {
            class AnimationClip extends EventEmitter {
                ...
                start(forceStart = false) {
                    ...
                    let _this = this;
                    this.tween = new TWEEN.Tween(startValues).to(endValues, this._duration).delay(this._delay).onStart(function () {
                        _this.playing = true;
                    ...
                    }).easing(this._easing).start().onComplete(function () {
                        _this.playing = false;
                ...
                static normalizeParams(e, params, obj) {
                    ...
                    for (let i in _params) {
                        if (!_params.hasOwnProperty(i)) continue;
            ...
            _export('AnimationClip', AnimationClip);
