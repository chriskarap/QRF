System.register(['./AnimationClip', '../plugin', '../constants', '../utils'], function (_export, _context) {
    "use strict";

    var AnimationClip, SculptPlugin, CONST, object;
    return {
        setters: [function (_AnimationClip) {
            AnimationClip = _AnimationClip.AnimationClip;
        }, function (_plugin) {
            SculptPlugin = _plugin.SculptPlugin;
        }, function (_constants) {
            CONST = _constants;
        }, function (_utils) {
        ...
        execute: function () {
            ...
            class AnimationPlugin extends SculptPlugin {
                constructor() {
                    super();
                    /**
            ...
            _export('AnimationPlugin', AnimationPlugin);
        }
    };
});