System.register(['./VerticalGrid', '../math', '../constants', '../sculpt', '../scene', '../math/Quaternion', '../rodinEvent'], function (_export, _context) {
    "use strict";

    var VerticalGrid, Vector3, CONST, Cylinder, Scene, Quaternion, RodinEvent;
    return {
        setters: [function (_VerticalGrid) {
            VerticalGrid = _VerticalGrid.VerticalGrid;
        }, function (_math) {
        ...
        execute: function () {
             ...
             */
            class VerticalSemiCircleGrid extends VerticalGrid {
            ...
            _export('VerticalSemiCircleGrid', VerticalSemiCircleGrid);
        }
    };
});