System.register(['./HorizontalGrid', '../math', '../constants', '../sculpt', '../scene', '../math/Quaternion', '../rodinEvent'], function (_export, _context) {
    "use strict";

    var HorizontalGrid, Vector3, CONST, Cylinder, Scene, Quaternion, RodinEvent;
    return {
        setters: [function (_HorizontalGrid) {
            HorizontalGrid = _HorizontalGrid.HorizontalGrid;
        }, function (_math) {
            Vector3 = _math.Vector3;
        }, function (_constants) {
            CONST = _constants;
        }, function (_sculpt) {
            Cylinder = _sculpt.Cylinder;
        }, function (_scene) {
            Scene = _scene.Scene;
        ...
        execute: function () {
             ...
             */
            class HorizontalSemiCircleGrid extends HorizontalGrid {
                ...
                _getMainSculpt() {
                    if (this.sculpt) return this.sculpt;
            ...
            _export('HorizontalSemiCircleGrid', HorizontalSemiCircleGrid);
        }
    };
});