System.register(['./shape/Curve', './shape/Parabola', './shape/Line', './Vector3', './Quaternion', './Euler'], function (_export, _context) {
    "use strict";

    var Curve, Parabola, Line, Vector3, Quaternion, Euler;
    ...
    _export('solveQuadratic', solveQuadratic);

    function getIntersections(curve1, curve2) {
    ...
    _export('getIntersections', getIntersections);
    ...
    _export('pointInTriangle', pointInTriangle);

    function getIntersectionsLineParabola(line, parabola) {
        if (parabola.mainAxis.y) {
            let t1 = [];
            if (line.a) {
                t1 = solveQuadratic(line.a * parabola.a, parabola.b * line.a + line.b * parabola.direction.x, line.a * (parabola.c + parabola.shift.y - line.initialPoint.y) + line.b * (line.initialPoint.x - parabola.shift.x));
            } else {
                t1 = solveQuadratic(line.c * parabola.a, parabola.b * line.c + line.b * parabola.direction.z, line.c * (parabola.c + parabola.shift.y - line.initialPoint.y) + line.b * (line.initialPoint.z - parabola.shift.z));
            }
    ...
    function getIntersectionsPlaneParabola(plane, parabola) {
        if (parabola.mainAxis.y) {
            const t = solveQuadratic(plane.normal.y * parabola.a, plane.normal.y * parabola.b - plane.normal.x * parabola.direction.x - plane.normal.z * parabola.direction.z, plane.normal.x * parabola.shift.x + plane.normal.y * (parabola.c + parabola.shift.y) + plane.normal.z * parabola.shift.z + plane.shift);
    ...
    _export('getIntersectionsPlaneParabola', getIntersectionsPlaneParabola);
    ...
    return {
        setters: [function (_shapeCurve) {
            Curve = _shapeCurve.Curve;
        }, function (_shapeParabola) {
            Parabola = _shapeParabola.Parabola;
        }, function (_shapeLine) {
            Line = _shapeLine.Line;
        }, function (_Vector) {
