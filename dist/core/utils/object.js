System.register(['./string'], function (_export, _context) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            _export('getProperty', getProperty);

            const setProperty = (obj, prop, val) => {
                let props = prop.split('.');
                let tmp = obj;
            ...
            _export('setProperty', setProperty);

            const clone = obj => {
                if (obj === null || typeof obj !== 'object' || 'isActiveClone' in obj) return obj;

                let temp = null;
                if (obj instanceof Date) temp = new obj.constructor();else temp = obj.constructor();
            ...
            const deepAssign = target => {
                ...
                for (let s = 1; s < _arguments.length; s++) {
                    assign(target, _arguments[s]);
                }
                return target;
            };

            _export('deepAssign', deepAssign);
        }
    };
});