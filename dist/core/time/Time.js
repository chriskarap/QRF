System.register(['../error', '../messenger', '../constants', '../utils'], function (_export, _context) {
    "use strict";

    var ErrorProtectedClassInstance, ErrorProtectedMethodCall, messenger, CONSTANTS, utils;
    return {
        setters: [function (_error) {
            ErrorProtectedClassInstance = _error.ErrorProtectedClassInstance;
