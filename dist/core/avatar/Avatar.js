System.register(['../sculpt', '../camera', '../messenger', '../utils/AScheme', '../utils', '../constants/', '../device', '../transport', '../math/Vector3'], function (_export, _context) {
    "use strict";

    var Sculpt, HMDCamera, messenger, AScheme, utils, CONST, device, postMessageTransport, Vector3;
    return {
        setters: [function (_sculpt) {
            Sculpt = _sculpt.Sculpt;
        }, function (_camera) {
            HMDCamera = _camera.HMDCamera;
        }, function (_messenger) {
        ...
        }, function (_mathVector) {
            Vector3 = _mathVector.Vector3;
        }],
        execute: function () {
